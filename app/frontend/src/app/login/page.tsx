      ...
      >
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-5">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full h-12 mt-4 rounded-full border border-white/30 bg-white text-black font-semibold tracking-wide font-sans transition-all duration-200 hover:scale-[1.02] active:scale-[0.98] cursor-pointer disabled:opacity-50 flex items-center justify-center gap-2.5 stagger-item"
          >
            {loading && (
              <svg className="animate-spin h-4.5 w-4.5 text-black" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
